...
function mesh_structured(geo::GeoModel, ndim::Int=0)
    ...
    mesh.nodes = collect(values(nodes_d.store))
    mesh.elems = cells
...
# Splits a block
function split_block!(cells::Vector{Cell}, nodes_d::NodePosMap, bl::Block)
    ...
    if shape==LIN2
        ...
        for i = 1:nx
            ...
            cell = Cell(shape, :line, [p1, p2], tag=bl.tag)
            push!(cells, cell)
        end
        return
    end
    ...
    if shape==LIN3
        p_arr = Array{Node}(undef, 2*nx+1)
            ...
            for i = 1:2:2*nx
                ...
                cell = Cell(shape, :line, [p1, p2, p3], tag=bl.tag)
                push!(cells, cell)
            end
        return
    end
    ...
    if shape==LIN4
        p_arr = Array{Node}(undef, 3*nx+1)
            ...
            for i = 1:3:3*nx
                ...
                cell = Cell(shape, :line, [p1, p2, p3, p4], tag=bl.tag)
                push!(cells, cell)
            end
        return
    end
    ...
    if shape in (QUAD4, TRI3)
        ...
        for j = 1:ny
            for i = 1:nx
                ...
                if shape==QUAD4
                    cell = Cell(shape, :solid, [p1, p2, p3, p4], tag=bl.tag)
                    push!(cells, cell)
                else
                    ...
                    cell1 = Cell(shape, :solid, [p1, p2, p5], tag=bl.tag)
                    cell2 = Cell(shape, :solid, [p2, p3, p5], tag=bl.tag)
                    cell3 = Cell(shape, :solid, [p3, p4, p5], tag=bl.tag)
                    cell4 = Cell(shape, :solid, [p4, p1, p5], tag=bl.tag)
                    push!(cells, cell1)
                    push!(cells, cell2)
                    push!(cells, cell3)
                    push!(cells, cell4)
    ...
    if shape in (QUAD8, QUAD9)
        ...
        for j = 1:2:2*ny
            for i = 1:2:2*nx
                ...
                if shape==QUAD8
                    cell = Cell(shape, :solid, [p1, p2, p3, p4, p5, p6, p7, p8], tag=bl.tag)
                else
                    p9   = p_arr[i+1, j+1]
                    cell = Cell(shape, :solid, [p1, p2, p3, p4, p5, p6, p7, p8, p9], tag=bl.tag)
                end
                push!(cells, cell)
            end
        end
    ...
    if shape == QUAD12
        ...
        for j = 1:3:3*ny
            for i = 1:3:3*nx
                ...
                cell = Cell(shape, :solid, [p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12], tag=bl.tag)
                push!(cells, cell)
            end
        end
        return
    ...
    #             cell1 = Cell(shape, :solid, [p1, p2, p3], tag=bl.tag)
    #             cell2 = Cell(shape, :solid, [p4, p1, p3], tag=bl.tag)
    #             push!(cells, cell1)
    #             push!(cells, cell2)
    #         end
    #     end
    ...
    if shape == TRI6
        ...
        for j = 1:2:2*ny
            for i = 1:2:2*nx
                ...
                cell1 = Cell(shape, :solid, [p1, p2, p3, p5, p6, p9], tag=bl.tag)
                cell2 = Cell(shape, :solid, [p4, p1, p3, p8, p9, p7], tag=bl.tag)
                push!(cells, cell1)
                push!(cells, cell2)
            end
        end
        ...
        for k = 1:nz
            for j = 1:ny
                for i = 1:nx
                    ...
                    if shape==TET4
                        push!( cells, Cell(shape, :solid, [p2, p4, p1, p8], tag=bl.tag) )
                        push!( cells, Cell(shape, :solid, [p2, p1, p5, p8], tag=bl.tag) )
                        push!( cells, Cell(shape, :solid, [p2, p5, p6, p8], tag=bl.tag) )
                        push!( cells, Cell(shape, :solid, [p2, p6, p7, p8], tag=bl.tag) )
                        push!( cells, Cell(shape, :solid, [p2, p3, p4, p8], tag=bl.tag) )
                        push!( cells, Cell(shape, :solid, [p2, p7, p3, p8], tag=bl.tag) )
                    end
                    if shape==PYR5
                        ...
                        cell1 = Cell(shape, :solid, [p1, p2, p3, p4, p9], tag=bl.tag)
                        cell2 = Cell(shape, :solid, [p2, p6, p7, p3, p9], tag=bl.tag)
                        cell3 = Cell(shape, :solid, [p4, p3, p7, p8, p9], tag=bl.tag)
                        cell4 = Cell(shape, :solid, [p1, p4, p8, p5, p9], tag=bl.tag)
                        cell5 = Cell(shape, :solid, [p2, p1, p5, p6, p9], tag=bl.tag)
                        cell6 = Cell(shape, :solid, [p6, p5, p8, p7, p9], tag=bl.tag)
                        push!(cells, cell1)
                        push!(cells, cell2)
                        push!(cells, cell3)
                        push!(cells, cell4)
        ...
        for k = 1:2:2*nz
            for j = 1:2:2*ny
                for i = 1:2:2*nx
                    ...
                    if shape == HEX20
                        cell = Cell(shape, :solid, [p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20], tag=bl.tag)
                        push!(cells, cell)
                    end
                    if shape in (TET10, HEX27)
                        ...
                        if shape==TET10
                            push!( cells, Cell(shape, :solid, [p2, p4, p1, p8, p25, p12, p9,  p27, p20, p21], tag=bl.tag) )
                            push!( cells, Cell(shape, :solid, [p2, p1, p5, p8, p9,  p17, p23, p27, p21, p16], tag=bl.tag) )
                            push!( cells, Cell(shape, :solid, [p2, p5, p6, p8, p23, p13, p18, p27, p16, p26], tag=bl.tag) )
                            push!( cells, Cell(shape, :solid, [p2, p6, p7, p8, p18, p14, p22, p27, p26, p15], tag=bl.tag) )
                            push!( cells, Cell(shape, :solid, [p2, p3, p4, p8, p10, p11, p25, p27, p24, p20], tag=bl.tag) )
                            push!( cells, Cell(shape, :solid, [p2, p7, p3, p8, p22, p19, p10, p27, p15, p24], tag=bl.tag) )
                        else
                            cell = Cell(shape, :solid, [p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27], tag=bl.tag)
                            push!(cells, cell)
                        end
                    end
                end
